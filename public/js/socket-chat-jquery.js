...
function renderUsuarios(usuarios) {
    ...
    for (var index = 0; index < usuarios.length; index++) {
        html += '<li>'
        html += '<a data-id="' + usuarios[index].id + '" href="javascript:void(0)"><img src="assets/images/users/1.jpg" alt="user-img" class="img-circle"> <span>' + usuarios[index].nombre + ' <small class="text-success">online</small></span></a>'
        html += '</li>'
    }
